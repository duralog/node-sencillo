 ...
 * @returns {Boolean} true if object exists, false if not.
 * @throws If an error occurs.
 */
 ...
 * @property {String} tree The ID of the tree associated with the commit.
 ...
 * @class
 * @property {String} id SHA1 hash of the object (may be a {@link Blob} or a sub{@link Tree}) this entry points to.
 * @property {String} name Filename of the entry.
 * @property {Integer} attributes UNIX file attributes for the entry.
 */
 ...
 * @property {String} type The type of reference this is. Can be either "oid" or "symbolic". CANNOT be changed (see {@link Reference#setTarget}).
 * @property {String} target The SHA1 hash of the {@link Commit} being pointed to by this Reference, if its type is "oid". If it's a symbolic Reference, this will point to another reference name.
 * 
 ...
 * @class
 * @property {String} id The SHA1 hash ID of the Blob.
...
/**
 * Pushes a {@link Commit} onto the Revision Walker to begin the walking process.
 * @param {String|Commit} commit The commit to push onto the walker. Can either be an SHA1 hash, or a previously loaded {@link Commit}.
 * @returns {Boolean} true if successful.
...
/**
 * Hides a specific {@link Commit} (and all its ancestors/descendants) from the walker.
 * @param {String|Commit} commit The commit to ignore. Can either be a SHA1 hash, or a previously loaded {@link Commit}.
...
/**
 * Gets the next {@link Commit} in the queue from the RevisionWalker.
...
/**
 * @class
 * @property {String} id <i>Read-only</i> The SHA1 hash ID of this Tag.
 ...
 * @property {String} targetId The ID of the object this Tag is pointing at.
 ...
 * @property {Date} time Time from epoch, in seconds
 * @property {Integer} timeOffset Timezone offset in minutes, e.g GMT-10 is stored as -600.
 */
